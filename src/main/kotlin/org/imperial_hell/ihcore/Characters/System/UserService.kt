...
import org.imperial_hell.ihcore.Files.MongoConverter
...
class UserService(private val databaseManager: DatabaseManager) {
    ...
    fun saveOrUpdateCharacterForUser(userUuid: String, character: Character): Boolean {
        return try {
            ...
            val characterDocument = MongoConverter.mapCharacterToDocument(character)
        ...
        return try {
            ...
            if (profile != null) {
                ...
                if (selectedIndex in characters.indices) {
                    ...
                    val character = MongoConverter.mapDocumentToCharacter(characterDoc)
