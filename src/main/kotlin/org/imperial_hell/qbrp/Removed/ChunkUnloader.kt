...
//    var unloadCycle = qbTimer(20 * unloadCycleDuration) { checkout() }.start()
//    var blocksUnloaded = false
//
//    init {
//        ChunkUnloaderSpace.addUnloader(this, this.chunk.pos)
//    }
//
//    fun checkout() {
...
//            blocksUnloaded = true
//            IhLogger.log("Чанк выгружен!", debugMode = true)
//        }
//    }
//
//    fun load() {
//        chunkHandler.loadChunk(world, chunk)
//        unloadCycle.start()
//        blocksUnloaded = false
//    }
//}
